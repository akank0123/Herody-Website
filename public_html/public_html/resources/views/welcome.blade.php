  ...
  Get Started With Us <i class="fa-solid fa-long-arrow-right"></i>
            ...
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-lg-2 col-md-12">
                        <div class="skill-image text-lg-left text-center content-mb-md img-fluid">
                            <img src="https://www.1mg.com/images/tata_1mg_logo.svg" alt="Image" class="animate-float-bob-x">
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-12">
                        <div class="skill-image text-lg-right text-center content-mb-md-50 img-fluid">
                            <img src="https://media.swipepages.com/2021/9/guvi-logo-svg-2x-1-300-1.png" alt="Image" class="animate-float-bob-x">
                          </div>
                    </div>
                    <div class="col-lg-2 col-md-12">
                        <div class="skill-image text-lg-right text-center content-mb-md-50 img-fluid">
                             <img  src="https://www.anthemis.com/wp-content/uploads/2020/02/stocktwits-LOGO-20200115.png" alt="Image" class="animate-float-bob-x">
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-12">
                        <div class="skill-image text-lg-right text-center content-mb-md-50">
                             <img height="75" src="https://imgur.com/gYylUtm.png" alt="Image" class="animate-float-bob-x">
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-12">
                        <div class="skill-image text-lg-right text-center content-mb-md-50">
                             <img src="https://images.news18.com/ibnlive/uploads/2021/06/1623400286_waazirx.jpg" alt="Image" class="animate-float-bob-x">
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-12">
                        <div class="skill-image text-lg-right text-center content-mb-md-50">
                             <img src="https://assets-netstorage.groww.in/web-assets/billion_groww_desktop/prod/build/client/images/logo-dark-groww.83f43714.svg" alt="Image" class="animate-float-bob-x">
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-12">
                        <div class="skill-image text-lg-left text-center content-mb-md-50">
                            <img src="https://play-lh.googleusercontent.com/ryuYnI5Uy3GWAYFOYQJI-3IN1Gb0tPhd_UYeTuZA7AjP3NxL2ViTOrf5QsIIFNCWBdg" alt="Image" class="animate-float-bob-x">
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-12">
                        <div class="skill-image text-lg-right text-center content-mb-md-50">
                            <img src="https://upload.wikimedia.org/wikipedia/en/thumb/8/86/Altbalaji_Logo.svg/1200px-Altbalaji_Logo.svg.png" alt="Image" class="animate-float-bob-x">
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-12">
                        <div class="skill-image text-lg-right text-center content-mb-md-50">
                             <img src="https://play-lh.googleusercontent.com/UP6ycSfGJD7_tsgxBc2uT5-jZKXDsmh-xy3OiYyS8DvZqNTV-YV0vr4MiHxzgcfpyfh_" alt="Image" class="animate-float-bob-x">
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-12">
                        <div class="skill-image text-lg-right text-center content-mb-md-50">
                             <img  src="https://yt3.ggpht.com/ytc/AKedOLTRL7wSUj3TgGCio4HGEdI2pBjVkwSHX_lbUv5J2g=s900-c-k-c0x00ffffff-no-rj" alt="Image" class="animate-float-bob-x">
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-12">
                        <div class="skill-image text-lg-right text-center content-mb-md-50">
                            <img src="https://static.businessworld.in/article/article_extra_large_image/1592306157_OnYVcO_upGrad.jpg" alt="Image" class="animate-float-bob-x">
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-12">
                        <div class="skill-image text-lg-right text-center content-mb-md-50">
                            <img src="https://yt3.ggpht.com/ytc/AKedOLSYtcTB8_vP8SKdGZFU2Gmu-yBEoNwrxCglQG5dtkQ=s900-c-k-c0x00ffffff-no-rj" alt="Image" class="animate-float-bob-x">
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-12">
                        <div class="skill-image text-lg-left text-center content-mb-md-50">
                            <img src="https://cdn.techinasia.com/data/images/CyiHd2qjZScc0c7VSRY6xBSijZDbX0YjwiqHEIZn.jpeg" alt="Image" class="animate-float-bob-x">
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-12">
                        <div class="skill-image text-lg-right text-center content-mb-md-50">
                             <img src="https://s3-us-west-2.amazonaws.com/cbi-image-service-prd/modified/5ef59a0e-f928-431b-9aed-19cbb789994a.png" alt="Image" class="animate-float-bob-x">
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-12">
                        <div class="skill-image text-lg-right text-center content-mb-md-50">
                             <img  src="https://image4.owler.com/logo/myscoot_owler_20190801_114744_original.jpg" alt="Image" class="animate-float-bob-x">
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-12">
                        <div class="skill-image text-lg-right text-center content-mb-md-50">
                             <img  src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c7/HERE_logo.svg/1124px-HERE_logo.svg.png" alt="Image" class="animate-float-bob-x">
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-12">
                       <div class="skill-image text-lg-right text-center content-mb-md-50">
                             <img src="https://upload.wikimedia.org/wikipedia/commons/7/74/TechGig.com_Logo.png" alt="Image" class="animate-float-bob-x">
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-12">
    ...
    <section class="skill-section section-gap bg-color-primary-7 bg-cover-center" style="background-image: url({{asset('assets/digital/assets/img/service-bg-2.jpg')}});">
        ...
        <div class="slider">
            <div class="slide-track">
                ...
                <div class="slide">
                    <img src="{{asset('assets/digital/assets/img/colleges/2.png')}}" alt="" width="100%" height="100%">
                </div>
                <div class="slide">
                    <img src="{{asset('assets/digital/assets/img/colleges/3.png')}}" alt="" width="100%" height="100%">
                </div>
                <div class="slide">
                    <img src="{{asset('assets/digital/assets/img/colleges/4.png')}}" alt="" width="100%" height="100%">
                </div>
                <div class="slide">
                    <img src="{{asset('assets/digital/assets/img/colleges/5.png')}}" alt="" width="100%" height="100%">
                </div>
                <div class="slide">
                    <img src="{{asset('assets/digital/assets/img/colleges/6.png')}}" alt="" width="100%" height="100%">
                </div>
                <div class="slide">
                    <img src="{{asset('assets/digital/assets/img/colleges/7.png')}}" alt="" width="100%" height="100%">
                </div>
                <div class="slide">
                    <img src="{{asset('assets/digital/assets/img/colleges/8.png')}}" alt="" width="100%" height="100%">
                </div>
                <div class="slide">
                    <img src="{{asset('assets/digital/assets/img/colleges/9.png')}}" alt="Image" width="100%" height="100%">
                </div>
                <div class="slide">
                    <img src="{{asset('assets/digital/assets/img/colleges/10.png')}}" alt="" width="100%" height="100%">
                </div>
                <div class="slide">
                    <img src="{{asset('assets/digital/assets/img/colleges/11.png')}}" alt="" width="100%" height="100%">
                </div>
                <div class="slide">
                    <img src="{{asset('assets/digital/assets/img/colleges/12.png')}}" alt="" width="100%" height="100%">
                </div>
                <div class="slide">
                    <img src="{{asset('assets/digital/assets/img/colleges/13.png')}}" alt="" width="100%" height="100%">
                </div>
                <div class="slide">
                    <img src="{{asset('assets/digital/assets/img/colleges/14.png')}}" alt="" width="100%" height="100%">
                </div>
                <div class="slide">
                    <img src="{{asset('assets/digital/assets/img/colleges/15.png')}}" alt="" width="100%" height="100%">
                </div>
                <div class="slide">
                    <img src="{{asset('assets/digital/assets/img/colleges/16.png')}}" alt="" width="100%" height="100%">
                </div>
                <div class="slide">
                    <img src="{{asset('assets/digital/assets/img/colleges/17.png')}}" alt="Image" width="100%" height="100%">
                </div>
                <div class="slide">
                    <img src="{{asset('assets/digital/assets/img/colleges/18.png')}}" alt="" width="100%" height="100%">
                </div>
                <div class="slide">
                    <img src="{{asset('assets/digital/assets/img/colleges/19.png')}}" alt="" width="100%" height="100%">
                </div>
                <div class="slide">
                    <img src="{{asset('assets/digital/assets/img/colleges/20.png')}}" alt="" width="100%" height="100%">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="skill-section section-gap bg-color-primary-7 bg-cover-center" style="background-image: url({{asset('assets/digital/assets/img/service-bg-2.jpg')}});">
        ...
        <div class="slider">
            <div class="slide-track">
                <div class="slide">
                    <img src="https://www.1mg.com/images/tata_1mg_logo.svg" alt="" width="100%" height="100%">
                </div>
                <div class="slide">
                    <img src="https://media.swipepages.com/2021/9/guvi-logo-svg-2x-1-300-1.png" alt="" width="100%" height="100%">
                </div>
                <div class="slide">
                    <img src="https://www.anthemis.com/wp-content/uploads/2020/02/stocktwits-LOGO-20200115.png" alt="" width="100%" height="100%">
                </div>
                <div class="slide">
                    <img src="https://images.news18.com/ibnlive/uploads/2021/06/1623400286_waazirx.jpg" alt="" width="100%" height="100%">
                </div>
                <div class="slide">
                    <img src="https://imgur.com/gYylUtm.png" alt="" width="100%" height="100%">
                </div>
                <div class="slide">
                    <img src="https://play-lh.googleusercontent.com/ryuYnI5Uy3GWAYFOYQJI-3IN1Gb0tPhd_UYeTuZA7AjP3NxL2ViTOrf5QsIIFNCWBdg" alt="" width="100%" height="100%">
                </div>
                <div class="slide">
                    <img src="https://upload.wikimedia.org/wikipedia/en/thumb/8/86/Altbalaji_Logo.svg/1200px-Altbalaji_Logo.svg.png" alt="" width="100%" height="100%">
                </div>
                <div class="slide">
                    <img src="https://play-lh.googleusercontent.com/UP6ycSfGJD7_tsgxBc2uT5-jZKXDsmh-xy3OiYyS8DvZqNTV-YV0vr4MiHxzgcfpyfh_" alt="" width="100%" height="100%">
                </div>
                <div class="slide">
                    <img src="https://yt3.ggpht.com/ytc/AKedOLTRL7wSUj3TgGCio4HGEdI2pBjVkwSHX_lbUv5J2g=s900-c-k-c0x00ffffff-no-rj" alt="" width="100%" height="100%">
                </div>
                <div class="slide">
                    <img src="https://static.businessworld.in/article/article_extra_large_image/1592306157_OnYVcO_upGrad.jpg" alt="" width="100%" height="100%">
                </div>
                <div class="slide">
                    <img src="https://yt3.ggpht.com/ytc/AKedOLSYtcTB8_vP8SKdGZFU2Gmu-yBEoNwrxCglQG5dtkQ=s900-c-k-c0x00ffffff-no-rj" alt="" width="100%" height="100%">
                </div>
                <div class="slide">
                    <img src="https://cdn.techinasia.com/data/images/CyiHd2qjZScc0c7VSRY6xBSijZDbX0YjwiqHEIZn.jpeg" alt="" width="100%" height="100%">
                </div>
                <div class="slide">
                    <img src="https://s3-us-west-2.amazonaws.com/cbi-image-service-prd/modified/5ef59a0e-f928-431b-9aed-19cbb789994a.png" alt="" width="150%" height="100%">
                </div>
                <div class="slide">
                    <img src="https://image4.owler.com/logo/myscoot_owler_20190801_114744_original.jpg" alt="" width="100%" height="100%">
                </div>
                <div class="slide">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c7/HERE_logo.svg/1124px-HERE_logo.svg.png" alt="" width="100%" height="100%">
                </div>
                <div class="slide">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/7/74/TechGig.com_Logo.png" alt="" width="150%" height="100%">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="skill-section section-gap bg-color-primary-7 bg-cover-center" style="background-image: url({{asset('assets/digital/assets/img/service-bg-2.jpg')}});">
        ...
        <div class="slider">
            <div class="slide-track">
                <div class="slide">
                    <img src="https://static.theprint.in/wp-content/uploads/2017/08/logo_800x149_transp-1.png?compress=true&quality=80&w=300&dpr=1.3" alt="" width="100%" height="80%">
                </div>
                <div class="slide">
                    <img src="https://aniportalimages.s3.amazonaws.com/static/img/logo-white.png" alt="" width="200%" height="80%" style="background-color:black;">
                </div>
                <div class="slide">
                    <img src="https://ians.in/images/ians-logo/IANS-logo-6.png" alt="" width="200%" height="80%">
                </div>
                <div class="slide">
                    <img src="https://herody.in/ads/logo.png" alt="" width="200%" height="80%">
                </div>
                <div class="slide">
                    <img src="https://businessfortnight.com/wp-content/uploads/2021/02/logo1mobile.png" alt="" width="100%" height="80%">
                </div>
                <div class="slide">
                    <img src="https://yt3.ggpht.com/ytc/AKedOLTRL7wSUj3TgGCio4HGEdI2pBjVkwSHX_lbUv5J2g=s900-c-k-c0x00ffffff-no-rj" alt="" width="90%" height="80%">
                </div>
            </div>
        </div>
    </section>
