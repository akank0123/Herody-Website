...
@section('title','Manager | Create Form')
@section('content')
        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">
                        <h3>Build a question form</h3>
                        
                    </h5>
                </div>

                <form action="{{ route('manager.mission.storeForm') }}" method="POST" id="createFormForm">
                    @csrf 
                <input type="hidden" name="campid" value="{{$id}}" id="campid">
                            ...
                            <div class="col-md-4" style="display: none;" id="allows_edit_DIV">
                                <div class="form-group">
                                    ...
                                    <select name="allows_edit" id="allows_edit" class="form-control" required="required">
                                        <option value="0" selected>NO (submissions are final)</option>
