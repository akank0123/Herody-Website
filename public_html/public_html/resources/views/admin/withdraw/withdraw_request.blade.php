...
@section('title', 'Admin | withdraw request')

@section('body')

    <div class="container-fluid">
        <h2 class="mb-4">Withdraw Request</h2>
                    ...
                    @foreach($withdrawRequest as $withdrawRe)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="" class="btn btn-danger btn-sm btn-square" data-id="{{$withdrawRe->id}}" data-toggle="modal" data-target="#withdrawReject">Reject</a>

                                <a href="" class="btn btn-info btn-sm btn-square" data-id="{{$withdrawRe->id}}" data-toggle="modal"
                                   data-target="#withdrawApprove">Approved</a>
                            </td>
