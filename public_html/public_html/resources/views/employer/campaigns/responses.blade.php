@extends('employer.campaigns.form-layout')
@section('title','Employer | Form Responses')
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-6">
                    <form action="{{route('employer.mission.rejectResp')}}" method="post">
                        @csrf
	...
	<div class="modal-dialog" role="document">
	  <div class="modal-content">
		...
		<div class="modal-body">
		  <form action="{{route('employer.mission.acceptResp')}}" method="post">
			@csrf
            <input type="hidden" name="id" value="{{$camp->id}}">
